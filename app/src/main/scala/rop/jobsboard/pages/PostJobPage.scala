...
case class PostJobPage(
  ...
  override protected def renderFormContent(): List[Html[App.Msg]] = List(
    ...
    renderInput("Salary low", "salaryLo", "number", isRequired = false, value => UpdateSalaryLo(value.toInt)),
    renderInput("Salary high", "salaryHi", "number", isRequired = false, value => UpdateSalaryHi(value.toInt)),
